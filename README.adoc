= Spring Cloud Zuul RateLimit image:https://coveralls.io/repos/github/westarest/spring-cloud-zuul-ratelimit/badge.svg?branch=master["Coverage Status", link="https://coveralls.io/github/westarest/spring-cloud-zuul-ratelimit?branch=master"]
:toc:
